...
public class App {
	...
	public static void main(String[] args) {
		...
		/*
		 * Car swift = new Swift(); Car coralla = new Coralla();
		 * 
		 * System.out.println(swift.specs()); System.out.println(coralla.specs());
		 * 
		 ...
		 * System.out.println(mycar.specs()); context.close();
		 */
